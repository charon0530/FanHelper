...
#분류기를 학습할 사진 경로 설정
web_dir = '/Users/User2/Desktop/web/public/sorted/'
img_paths = {
    'DS': getdirpath(web_dir+'ds'),
    'GD': getdirpath(web_dir+'gd'),
    'SL': getdirpath(web_dir+'sl'),
    'TY': getdirpath(web_dir+'ty'),
    'TOP': getdirpath(web_dir+'top')
}
...
if test_mode == 0:
    ...
    path_dir = 'C:/Users/User2/Desktop/CT/test'
